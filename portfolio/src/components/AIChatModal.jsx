...
function TrialCTA() {
  return (
    <motion.div initial={{ opacity:0, y:10 }} animate={{ opacity:1, y:0 }}
      ...
      <p className="text-xs text-white/50 mb-3">Contact SmartFlow today to deploy this AI automation for your business.</p>
          ...
          <div className="px-4 py-3 border-t border-white/8 shrink-0"
            ...
            <div className="flex gap-2 items-end">
              <textarea ref={textRef} rows={1} value={input}
                ...
                className="flex-1 resize-none rounded-xl px-4 py-2.5 text-sm text-white placeholder-white/25 focus:outline-none focus:ring-1 transition-all disabled:opacity-40"
                style={{ background:'rgba(255,255,255,0.06)', border:'1px solid rgba(255,255,255,0.1)',
                  minHeight:'40px', focusRingColor: accentColor }} />
            ...
            <p className="text-[9px] text-white/20 text-center mt-1.5">
              SmartFlow AI Demo · {remaining} interaction{remaining!==1?'s':''} remaining
            </p>
          </div>
        )}
      </motion.div>
