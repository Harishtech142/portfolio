...
2. Sends an automatic "Thank You for Contacting SmartFlow" confirmation to the visitor.
...
3. Create a new app password (name it e.g. "SmartFlow Portfolio").
...
5. Once deployed, you'll get a URL like `https://smartflow-contact.onrender.com`.
